...
function NavbarPage() {
  ...
  const theme = useTheme()                            // automatically fetches color value from themesetting bases on dark or light mode
  ...
  return <FlexBetween padding="1rem 6%" backgroundColor={alt}>
    ...
    <FlexBetween gap="1.75rem">
      ...
      {/* SEARCH BAR ONLY FOR BIGGER SCREENS */}
      {isNonMobileScreens && (
        <FlexBetween
